 ...
 */
@ApiModel(value="增援编队",description="增援编队对象")
public class Zybd {
    ...
    private String lxdh;
    @ApiModelProperty(value="增援形式，1：按微型编队增援 2：按车辆进行增援", example="1")
    private String zyxs;
    @ApiModelProperty(value="增援情况")
    private List<InnerZyqk> zyqk;
    ...
    public List<InnerZyqk> getZyqk() {
        return zyqk;
    }

    public void setZyqk(List<InnerZyqk> zyqk) {
        this.zyqk = zyqk;
    }
    ...
    public List<InnerClqk> getXfclqk() {
        return xfclqk;
    }

    public void setXfclqk(List<InnerClqk> xfclqk) {
        this.xfclqk = xfclqk;
    }
