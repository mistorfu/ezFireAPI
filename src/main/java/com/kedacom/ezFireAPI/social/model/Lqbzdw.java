 ...
 * @desc:联勤保障单位
 */
@ApiModel(value = "联勤保障单位", description = "联勤保障单位对象")
public class Lqbzdw {
    ...
    private InnerDxlbext bzlb;        //保障类别
    @ApiModelProperty(value = "保障能力")
    private InnerBznl bznl;      //保障能力
    @ApiModelProperty(value = "保障概述")
    private String bzgs;         //保障概述
    ...
    public InnerDxlbext getBzlb() {
        return bzlb;
    }

    public void setBzlb(InnerDxlbext bzlb) {
        this.bzlb = bzlb;
    }

    public InnerBznl getBznl() {
        return bznl;
    }

    public void setBznl(InnerBznl bznl) {
        this.bznl = bznl;
    }
